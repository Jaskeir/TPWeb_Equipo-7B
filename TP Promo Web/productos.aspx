...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="productos" runat="server">
                    ...
                    <div class="col-md-3 g-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <asp:Button ID="btnCanjear" runat="server" Text="Canjear" CssClass="btn btn-primary" OnClick="btnCanjear_Click" CommandArgument='<%# Eval("Id") %>' CommandName="productID" />
                            </div>
                        </div>
                    </div>
                </ItemTemplate>
